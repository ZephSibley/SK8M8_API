...
namespace Sk8M8_API.Migrations
{
    ...
    [Migration("20200509111357_LocationAndIdIndexing")]
    partial class LocationAndIdIndexing
    {
            ...
            modelBuilder.Entity("Sk8M8_API.Models.LocationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 379, DateTimeKind.Local).AddTicks(4193),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(110),
                            Name = "SkatePark"
                        },
                        new
                        {
                            Id = 2L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(884),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(894),
                            Name = "Rail"
                        },
                        new
                        {
                            Id = 3L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(906),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(909),
                            Name = "Ramp"
                        },
                        new
                        {
                            Id = 4L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(912),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(915),
                            Name = "Plaza"
                        },
                        new
                        {
                            Id = 5L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(918),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(920),
                            Name = "Pump track"
                        },
                        new
                        {
                            Id = 6L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(923),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(926),
                            Name = "Dirt track"
                        },
                        new
                        {
                            Id = 7L,
                            DateCreated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(929),
                            DateUpdated = new DateTime(2020, 5, 9, 12, 13, 57, 381, DateTimeKind.Local).AddTicks(931),
                            Name = "Skate path"
                        });
                });
