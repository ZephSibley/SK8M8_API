...
namespace Sk8M8_API.Migrations
{
    ...
    [Migration("20200509140633_MarkerStars")]
    partial class MarkerStars
    {
            ...
            modelBuilder.Entity("Sk8M8_API.Models.LocationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 324, DateTimeKind.Local).AddTicks(6582),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(3818),
                            Name = "SkatePark"
                        },
                        new
                        {
                            Id = 2L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4359),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4368),
                            Name = "Rail"
                        },
                        new
                        {
                            Id = 3L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4381),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4384),
                            Name = "Ramp"
                        },
                        new
                        {
                            Id = 4L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4387),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4389),
                            Name = "Plaza"
                        },
                        new
                        {
                            Id = 5L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4392),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4395),
                            Name = "Pump track"
                        },
                        new
                        {
                            Id = 6L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4398),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4401),
                            Name = "Dirt track"
                        },
                        new
                        {
                            Id = 7L,
                            DateCreated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4404),
                            DateUpdated = new DateTime(2020, 5, 9, 15, 6, 33, 326, DateTimeKind.Local).AddTicks(4406),
                            Name = "Skate path"
                        });
                });
